...
public class MainActivity extends AppCompatActivity {
    public static final String EXTRA_MESSAGE = "com.example.abraham.MESSAGE";
    @Override
    ...
    public void sendMessage(View view) {
        Intent intent = new Intent(this, DisplayMessageActivity.class); // (Context, Class of the app component to which the system should deliver the Intent)
